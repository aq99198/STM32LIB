...
//六轴  sqrt(3)/2 = 0.866f
	motor[m1] = ct_val_thr -ct_val_rol *0.866f +ct_val_pit +ct_val_yaw;
	motor[m2] = ct_val_thr +ct_val_rol *0.866f +ct_val_pit -ct_val_yaw;
	motor[m3] = ct_val_thr +ct_val_rol *0.866f             +ct_val_yaw;
	motor[m4] = ct_val_thr +ct_val_rol *0.866f -ct_val_pit -ct_val_yaw;	
	motor[m5] = ct_val_thr -ct_val_rol *0.866f -ct_val_pit +ct_val_yaw;
	motor[m6] = ct_val_thr -ct_val_rol *0.866f             -ct_val_yaw;	
