...
void MPU6050_setFullScaleGyroRange(uint8_t range) {
	...
	IICwriteBits(MPU6050_ADDR, MPU6050_RA_GYRO_CONFIG,7, 3, 0x00);   //???
}
...
void MPU6050_setFullScaleAccelRange(uint8_t range) {
	...
	IICwriteBits(MPU6050_ADDR, MPU6050_RA_ACCEL_CONFIG,7, 3, 0x00);   //???
...
//	Delay_ms(1);
	...
	delay(10);
	MPU6050_setFullScaleAccelRange(MPU6050_ACCEL_FS_8);	//加速度最大量程 +-8G
	delay(10);
...
//void mpu_type(float x,float y,float z)//6050??????
//{
//	float length;
...
////======================================================================
//	/*?????????*/
//	sensor.Gyro_deg.x = sensor.Gyro.x *0.0610361f ;//  /65535 * 4000; +-2000?
